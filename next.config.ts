        ...
        headers: [
          {
            ...
            value: [
              ...
              "media-src 'self' blob:",
              "connect-src 'self' https://*.llamarpc.com https://*.infura.io https://*.alchemy.com https://*.publicnode.com https://api.coingecko.com https://li.quest https://*.lifi.tools https://api.mainnet-beta.solana.com https://*.solana.com https://accounts.google.com https://*.googleapis.com https://mempool.space https://*.ninerealms.com https://gateway.liquify.com",
              "font-src 'self'",
